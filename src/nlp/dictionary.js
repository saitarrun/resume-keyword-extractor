...
const SKILL_DICTIONARY = [
  // =========================================================================
  // 1. AGILE, SCRUM & PROJECT DELIVERY
  // =========================================================================
  { term: 'Agile Methodology', aliases: ['agile methodologies', 'agile methodology', 'agile software development', 'agile environment', 'agile practices', 'agile process', 'agile frameworks', 'agile sprint', 'agile delivery', 'agile development', 'agile principles', 'agile'], type: 'Technical' },
  { term: 'Scrum', aliases: ['scrum framework', 'scrum methodology', 'scrum practices', 'scrum master', 'certified scrum master', 'csm', 'daily stand ups', 'daily stand-ups', 'daily standups', 'sprint planning', 'sprint review', 'sprint reviews', 'sprint retrospective', 'sprint retrospectives', 'retrospectives', 'sprint backlog', 'product backlog', 'backlog refinement', 'backlog grooming', 'sprints', 'sprint', 'scrum team', 'scrum'], type: 'Technical' },
  ...
  { term: 'Jira & Project Tracking', aliases: ['jira software', 'atlassian jira', 'confluence', 'atlassian confluence', 'jira ticket', 'jira tickets', 'jira'], type: 'Technical' },
  { term: 'Software Development Life Cycle (SDLC)', aliases: ['software development life cycle', 'full software development life cycle', 'software development lifecycle', 'software lifecycle', 'software development life-cycle', 'end-to-end sdlc', 'iterative development', 'sdlc'], type: 'Technical' },
  { term: 'Pair Programming', aliases: ['paired programming', 'pair programming', 'mob programming', 'peer programming'], type: 'Technical' },
  ...
  { term: 'Unit Testing', aliases: ['unit testing', 'unit tests', 'unit test', 'automated unit tests', 'write unit tests', 'writing unit tests', 'jest', 'vitest', 'mocha', 'chai', 'junit', 'junit 5', 'pytest', 'unittest', 'nunit', 'xunit', 'mutation testing', 'test coverage'], type: 'Technical' },
  ...
  { term: 'Testing Frameworks & QA Automation', aliases: ['testing frameworks', 'testing framework', 'test frameworks', 'test framework', 'automated testing', 'test automation', 'regression testing', 'regression tests', 'automated test suites', 'qa automation', 'quality assurance', 'test harness', 'test harnesses', 'system testing', 'test cases', 'test case', 'test planning', 'hp quality center', 'hp alm', 'software quality assurance'], type: 'Technical' },
  { term: 'Debugging & Profiling', aliases: ['troubleshoot issues', 'troubleshooting', 'debug applications', 'debugging', 'root cause analysis', 'rca', 'memory leaks detection', 'profiling', 'memory profiling'], type: 'Technical' },

  // =========================================================================
  // 3. DEVOPS, CI/CD, CLOUD NATIVE & INFRASTRUCTURE
  // =========================================================================
  { term: 'DevOps & SRE', aliases: ['devops best practices', 'devops practices', 'devops engineer', 'devops', 'dev ops', 'dev-ops', 'devsecops', 'site reliability engineering', 'system reliability', 'sre', 'production reliability', 'high availability', 'fault tolerance', 'incident response'], type: 'Technical' },
  { term: 'Cloud Computing & Cloud Native', aliases: ['cloud native technologies', 'cloud native technology', 'cloud-native technologies', 'cloud-native technology', 'cloud native', 'cloud-native', 'cloud environments', 'cloud environment', 'cloud platforms', 'cloud platform', 'cloud infrastructure', 'cloud architecture', 'cloud computing', 'multi-cloud', 'hybrid cloud', 'public cloud'], type: 'Technical' },
  ...
  { term: 'Docker & Containers', aliases: ['docker products', 'docker', 'containerization', 'containerized', 'dockerfile', 'docker compose', 'container registry', 'podman', 'containerd', 'crun', 'runc'], type: 'Technical' },
  ...
  { term: 'Observability & Monitoring', aliases: ['system monitoring', 'application monitoring', 'observability', 'prometheus', 'grafana', 'datadog', 'new relic', 'splunk', 'sentry', 'opentelemetry', 'otel', 'log aggregation', 'centralized logging', 'alerting', 'pagerduty', 'dynatrace', 'jaeger', 'loki', 'tempo', 'mimir', 'thanos', 'honeycomb'], type: 'Technical' },
  ...
  // =========================================================================
  { term: 'Technical Design & Architecture', aliases: ['technical design documents', 'technical design document', 'technical design', 'technical specifications', 'technical specification', 'tech design', 'tech specs', 'tech spec', 'design documents', 'design document', 'design doc', 'design docs', 'detailed technical design', 'architecture design', 'system architecture', 'software architecture', 'application architecture', 'technical architecture', 'systems architecture', 'clean architecture', 'hexagonal architecture', 'onion architecture', 'system design & scalability', 'system design', 'software design'], type: 'Technical' },
  { term: 'Scalability & Performance Optimization', aliases: ['optimize system performance', 'system performance', 'performance optimization', 'performance standards', 'performance best practices', 'latency reduction', 'high throughput', 'low latency', 'high scalability'], type: 'Technical' },
  ...
  // =========================================================================
  // 7. FRONTEND, BACKEND, FULL-STACK & WEB FRAMEWORKS
  // =========================================================================
  { term: 'Frontend Development', aliases: ['front end frameworks', 'front-end frameworks', 'frontend frameworks', 'front-end framework', 'frontend framework', 'front end framework', 'front-end development', 'frontend development', 'front end development', 'frontend engineering', 'frontend systems', 'frontend architecture', 'front-end', 'frontend', 'front end', 'web development', 'responsive web design', 'progressive web apps (pwa)', 'pwa', 'user experience (ux)', 'ux', 'ui/ux', 'search engine optimization (seo)', 'seo'], type: 'Technical' },
  { term: 'Backend Development', aliases: ['backend development', 'back-end development', 'backend systems', 'back-end systems', 'backend services', 'back-end services', 'backend engineering', 'back-end engineering', 'backend architecture', 'back-end architecture', 'backend infrastructure', 'backend APIs', 'backend', 'back-end', 'back end', 'server-side development', 'server-side'], type: 'Technical' },
  { term: 'Full-Stack Development', aliases: ['full-stack development', 'full stack development', 'fullstack development', 'full-stack engineering', 'full stack engineering', 'full-stack systems', 'full-stack', 'full stack', 'fullstack'], type: 'Technical' },
  { term: 'API Integrations & Services', aliases: ['third-party integrations', 'third party integrations', 'api integrations', 'api integration', 'enterprise integrations', 'system integrations', 'third-party apis', 'third party apis', 'integrations', 'integration'], type: 'Technical' },
  { term: 'Workflow Automation & Engines', aliases: ['workflow builder', 'execution engine', 'execution engines', 'workflow automation', 'business workflows', 'automation workflows', 'workflow orchestration', 'automations', 'automated workflows', 'task automation'], type: 'Technical' },
  { term: 'Enterprise Systems & Platform', aliases: ['enterprise systems', 'enterprise system', 'enterprise platform', 'platform engineering', 'internal developer platform', 'developer platforms', 'core platform'], type: 'Technical' },
  ...
  // =========================================================================
  { term: 'Data Security & Privacy', aliases: ['data security', 'data privacy', 'data protection', 'data masking', 'data encryption', 'database security', 'pii protection', 'sensitive data protection', 'column-level security', 'row-level security'], type: 'Technical' },
  { term: 'Cloud Security & IAM', aliases: ['cloud security', 'aws security', 'azure security', 'gcp security', 'cloud posture', 'cspm', 'ciem', 'cloud workload protection', 'cwpp', 'iam security'], type: 'Technical' },
  { term: 'Application Security (AppSec)', aliases: ['application security', 'appsec', 'product security', 'prodsec', 'software security', 'code security', 'secure code review', 'sast', 'dast', 'snyk', 'sonarqube', 'static analysis', 'threat modeling', 'zero trust', 'zero-trust'], type: 'Technical' },
  { term: 'Network & Infrastructure Security', aliases: ['network security', 'infrastructure security', 'firewall', 'firewalls', 'waf', 'web application firewall', 'vpn', 'ddos mitigation', 'ddos protection', 'tls/ssl', 'ssl/tls', 'tls encryption'], type: 'Technical' },
  { term: 'Cybersecurity & InfoSec', aliases: ['cybersecurity', 'cyber security', 'information security', 'infosec', 'security architecture', 'security operations', 'secops', 'vulnerability assessment', 'vulnerability management', 'penetration testing', 'pen testing'], type: 'Technical' },
  { term: 'Auth, SSO & Identity (OAuth/JWT)', aliases: ['authentication', 'authorization', 'oauth 2.0', 'oauth2', 'oauth', 'json web tokens', 'json web token', 'jwt', 'sso', 'saml', 'saml 2.0', 'oidc', 'openid connect', 'auth0', 'clerk', 'cognito', 'okta', 'mfa', 'multi-factor authentication', 'rbac', 'abac', 'keycloak', 'passkeys', 'webauthn'], type: 'Technical' },
  { term: 'EDR, SIEM & Incident Response', aliases: ['edr', 'xdr', 'siem', 'soar', 'crowdstrike', 'crowdstrike falcon', 'falcon sensor', 'mitre att&ck', 'threat hunting', 'incident response', 'endpoint protection', 'splunk siem'], type: 'Technical' },
  { term: 'PKI, HSM & Secrets Infrastructure', aliases: ['pki', 'public key infrastructure', 'hsm', 'hardware security module', 'hsms', 'secrets management', 'hashicorp vault', 'vault', 'workload identity', 'intel sgx', 'confidential computing', 'certificates'], type: 'Technical' },
  ...
  { term: 'Compliance, Governance & Standards', aliases: ['ssl', 'tls', 'ssl/tls', 'tls encryption', 'aes', 'rsa', 'encryption', 'cryptography', 'gdpr', 'hipaa', 'soc 2', 'soc 2 type ii', 'pci dss', 'fedramp', 'iso 27001'], type: 'Technical' },
  ...
  { term: 'AI Evaluation & Feedback Loops (Evals)', aliases: ['evaluation systems', 'evaluation system', 'eval systems', 'feedback loops', 'feedback loop', 'evaluation harnesses', 'model evaluation', 'model evaluations', 'llm evals', 'evals', 'benchmarking', 'llm-as-a-judge', 'model benchmark', 'eval harness', 'automated evals'], type: 'Technical' },
